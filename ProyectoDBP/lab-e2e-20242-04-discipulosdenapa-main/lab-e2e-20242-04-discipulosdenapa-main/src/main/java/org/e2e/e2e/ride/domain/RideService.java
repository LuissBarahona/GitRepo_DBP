...
public class RideService {
    ...
    @Autowired
    public RideService(RideRepository rideRepository, PassengerRepository passengerRepository, DriverRepository driverRepository, AuthorizationUtils authorizationUtils) {
