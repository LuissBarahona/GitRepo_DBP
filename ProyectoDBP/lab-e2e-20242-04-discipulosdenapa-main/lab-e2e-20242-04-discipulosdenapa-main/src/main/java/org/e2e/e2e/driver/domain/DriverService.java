...
public class DriverService {
    ...
    public DriverResponseDto getDriverInfo(Long id) {
        if(!authorizationUtils.isAdminOrResourceOwner(id))
            throw new UnauthorizeOperationException("You are not authorized to access this resource");
    ...
    public DriverResponseDto getDriverOwnInfo() {
        ...
        if(username == null) throw new UnauthorizeOperationException("Anonymous User not allowed to acess this resource");
